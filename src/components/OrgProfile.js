              ...
              <div className="px-6">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  <div class="w-full px-3 mb-6 md:mb-0">
                    <label
                      ...
                      for="grid-org-mobile"
                    >
                      Edit Organisation Number
                    </label>
                    <input
                      class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-org-mobile"
                      type="text"
                      placeholder={user?.OrganisationMobile}
                ...
                <div class="flex flex-wrap -mx-3 mb-6 pt-5">
                  <div class="w-full px-3 mb-6 md:mb-0">
                    <label
                      class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                      for="grid-full-contact-name"
                    >
                      Edit Contact Person Name
                    </label>
                    <input
                      class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-full-contact-name"
                      type="text"
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  <div class="w-full px-3 mb-6 md:mb-0">
                    <label
                      class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                      for="grid-contact-mobile"
                    >
                      Edit Contact Person Number
                    </label>
                    <input
                      class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-contact-mobile"
                      type="text"
                ...
                <div class="flex flex-wrap -mx-3 mb-6 pt-10">
                  <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <label
                      ...
                      for="grid-curr-email"
                    >
                      Enter Current Organisation Email
                    </label>
                    <input
                      class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-curr-email"
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  <div class="w-full px-3">
                    <label
                      class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                      for="grid-curr-password"
                    >
                      Enter Current Password
                    </label>
                    <input
                      class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-curr-password"
                      type="password"
                      placeholder={"**********"}
                ...
                <div className="w-full px-0 lg:order-3 lg:text-right lg:self-center">
                  <div className="py-1 px-0 mt-10 sm:mt-0">
                    <button
                      className="bg-blue-900 active:bg-blue-900 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                      type="button"
                      style={{ transition: "all .15s ease" }}
...
export default withRouter(OrgProfile);
