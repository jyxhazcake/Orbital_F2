...
export default function TermsOfUse() {
  return (
    <>
      ...
      <div>
        <p className="text-lg"><strong>Terms and Conditions of Use</strong></p>
        <p className="my-2"><strong>1. Agreement to Terms: </strong>
           All access of any area
        ...
        <p className="my-2"><strong>2. Access To The Website: </strong>
        ...
        <p className="my-2"><strong>3. Relying On Information: </strong>
        ...
        <p className="my-2"><strong>4. Security: </strong>
        ...
        <p className="my-2"> <strong> 5. Hyperlinks: </strong>
        ...
        <p className="my-2"><strong>6. </strong>
         Intellectual Property Materials, including source code,
        ...
        purposes whatsoever without our prior written permission. 
          ...
          <p className="my-2"><strong>7. General Disclaimer And Limitation Of Liability: </strong>
        ...
        any person who accesses or uses The Website. </p>
        <p className="my-2"><strong>8. Fees: </strong> There are currently
        ...
        <p><strong>9. Applicable Laws: </strong>
         Use of The Website and these Terms are governed by the
        laws of Singapore. Any claim relating to use of The Website shall be
        heard by Singapore Courts.
        </p>
        <p className="my-2">
          <strong>10. Variation: </strong> We may revise these Terms at
