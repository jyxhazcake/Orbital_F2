...
export default function TermsOfUse() {
  return (
    <>
      <div>
        Terms and Conditions of Use 1. Agreement to Terms All access of any area
        ...
        "our" and "us" refers to the Government of Singapore. 2. Access To The
        Website The accessibility and operation of The Website relies on
        technologies outside our control. We do not guarantee continuous
        accessibility or uninterrupted operation of The Website. 3. Relying On
        Information We provide The Website as a general information source only
        ...
        professional advice relevant to your particular circumstances. 4.
        Security Where appropriate, we use available technology to protect the
        ...
        confidential. 5. Hyperlinks We are not responsible or liable for the
        ...
        The Website. 6. Intellectual Property Materials, including source code,
        ...
        purposes whatsoever without our prior written permission. 7. General
        Disclaimer And Limitation Of Liability We will not be liable for any
        ...
        any person who accesses or uses The Website. 8. Fees There are currently
        ...
        fees charged by any other Internet site (not provided by us). 9.
        ...
        heard by Singapore Courts. 10. Variation We may revise these Terms at
